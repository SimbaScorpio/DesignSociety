...
//	public class MyRichAI2 : MonoBehaviour
//	{
...
//		{
//			while (true) {
//				while (!repeatedlySearchPaths || waitingForPathCalc || !canSearchPath || Time.time - lastRepath < repathRate)
//					yield return null;
//				//canSearchPath = false;
//
//				//waitingForPathCalc = true;
...
//		//{
//		//}
//		public EventHandler OnTargetReached;
//
//
...
//
//
//		/** Deal with player avoidance */
//		//		private GameObject[] playersInScene;
//		//		public float colliderForce = 2f;
//		//		public float colliderDist = 1f;
//		//
...
//		//		}
//		//
//		//		Vector3 CalculateForceFromColliders (Vector3 dir, Vector3 velocity)
//		//		{
//		//			if (colliders.Count == 0)
//		//				return Vector3.zero;
//		//			Vector3 tforce = Vector3.zero;
//		//			Vector3 force = Vector3.zero;
//		//			Vector3 mine, yours, direct;
//		//			float dist;
//		//			foreach (GameObject collider in colliders) {
//		//				yours = collider.transform.position;
...
//		//				tforce += force;
//		//			}
//		//			Vector3 temp = velocity + tforce * colliderForce * deltaTime;
//		//			float ans = Vector3.Dot (temp, dir);
//		//			if (ans < 0) {
//		//				tforce = Vector3.zero;
//		//			}
//		//			return tforce;
...
//
////					UpdateColliders ();
////					Vector3 cForce = CalculateForceFromColliders (dir, velocity);
////					velocity += cForce * colliderForce * deltaTime;
//
...
//					// Debug.DrawRay (position + Vector3.up * up, Vector3.down * up, Color.red);
//					if (Mathf.Abs (hit.distance - up) < 0.1f) {
//						position = hit.point;
//						velocity.y = 0;
//					} else if (hit.distance < up) {
...
//				return Mathf.Abs (eul.y - trot.y) < 1f;
//			}
//			return false;
//		}
//
